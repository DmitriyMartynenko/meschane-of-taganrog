    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="flex-col">
        <Card className="size-full max-h-[90dvh] gap-6 overflow-y-auto border-none p-0 shadow-none">
          ...
          <CardHeader className="flex-1 gap-2 px-4 text-center">
            <DialogTitle asChild>
          ...
          <CardContent className="flex-col gap-6 px-4">
            <div className="h-px bg-linear-to-r from-transparent via-primary/30 to-transparent" />
            <div className="flex flex-col items-center justify-center gap-4">
              <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 font-semibold text-primary">
