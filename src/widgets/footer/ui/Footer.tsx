  ...
  return (
    <footer className="flex">
      <div className="flex basis-1/2">
        <iframe className="w-full h-auto" src="https://yandex.ru/map-widget/v1/-/CDxqq6LW"></iframe>
      </div>
      <div className="flex flex-col basis-1/2 gap-16 p-16 bg-[linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(@/widgets/footer/assets/images/footer-background.png)] bg-cover bg-no-repeat bg-center">
        <Heading>
        ...
        <div className="flex flex-wrap gap-x-16 gap-y-8 text-foreground-secondary uppercase">
            <p>
